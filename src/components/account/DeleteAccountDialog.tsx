  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
        ...
        >
          <div className="mb-6">
            <h2 className="text-xl font-bold text-white mb-2">{t('manageAccount.deleteTitle')}</h2>
          ...
          <div className="mt-8 flex items-center justify-end gap-3">
            <button
              ...
              disabled={deleting}
              className="px-5 py-2.5 text-sm font-medium text-zinc-300 hover:text-white hover:bg-zinc-800 rounded-xl transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              className="px-5 py-2.5 bg-red-500 text-white text-sm font-bold rounded-xl hover:bg-red-600 transition-colors disabled:opacity-50 flex items-center gap-2"
            >
              {deleting ? (
