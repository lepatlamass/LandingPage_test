...
export default function YouTubeBanner() {
  return (
    <div className="bg-[#1a1c21] border border-white/5 rounded-3xl p-8 shadow-2xl mb-12 flex flex-col md:flex-row items-center justify-between gap-6">
      <div className="flex items-center gap-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-white mb-2">Subscribe to our YouTube Channel</h2>
          <p className="text-gray-400">Get step-by-step video tutorials and feature updates.</p>
        </div>
      </div>
      <a 
