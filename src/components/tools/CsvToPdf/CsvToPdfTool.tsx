    ...
    <div className="w-full max-w-5xl mx-auto">
      <div className="bg-white dark:bg-[#1a1c21] border border-zinc-300 dark:border-gray-800 rounded-[32px] overflow-hidden shadow-2xl">
        <div className="p-6 md:p-8 border-b border-zinc-300 dark:border-gray-800 flex flex-col md:flex-row items-start md:items-center justify-between bg-white/5 gap-6 md:gap-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-black dark:text-white">CSV to PDF</h3>
              <p className="text-black dark:text-gray-500 text-sm">Convert structured CSV data into professional PDF tables</p>
            </div>
          </div>
          {csvFile && (
            <button 
        ...
        <div className="p-8">
          {!csvFile ? (
            ...
            >
              ...
              <p className="text-black dark:text-gray-500 text-sm mb-8">Select a CSV file to convert</p>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-lg font-bold text-black dark:text-white truncate">{csvFile.file.name}</p>
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white/5 border border-black/10 dark:border-white/10 rounded-3xl p-8">
          ...
          <h4 className="text-black dark:text-white font-bold mb-4">Professional Tables</h4>
