    ...
    <div className="w-full max-w-5xl mx-auto">
      <div className="bg-[#1a1c21] border border-gray-800 rounded-[32px] overflow-hidden shadow-2xl">
        <div className="p-8 border-b border-gray-800 flex items-center justify-between bg-white/5">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-white">Excel to CSV</h3>
              <p className="text-gray-500 text-sm">Convert Excel spreadsheets to CSV format</p>
            </div>
          </div>
          {excelFile && (
            <button 
        ...
        <div className="p-8">
          {!excelFile ? (
            ...
            >
              ...
              <p className="text-gray-500 text-sm mb-8">Select an Excel file (.xlsx, .xls) to convert</p>
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
          ...
          <h4 className="text-white font-bold mb-4">Format Preserved</h4>
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
          ...
          <h4 className="text-white font-bold mb-4">Instant Results</h4>
          <p className="text-gray-500 text-sm leading-relaxed">
