    ...
    <div className="w-full max-w-5xl mx-auto">
      <div className="bg-[#1a1c21] border border-gray-800 rounded-[32px] overflow-hidden shadow-2xl">
        <div className="p-6 md:p-8 border-b border-gray-800 flex flex-col md:flex-row items-start md:items-center justify-between bg-white/5 gap-6 md:gap-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-white">SVG Converter</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {files.length < 10 && (
                  <button 
                    onClick={() => fileInputRef.current?.click()}
                    className="border-2 border-dashed border-gray-800 rounded-2xl p-4 flex items-center justify-center gap-3 text-gray-500 hover:border-indigo-400/30 hover:text-indigo-400 transition-all group"
                  >
              ...
              <div className="flex items-center justify-between pt-6 border-t border-gray-800">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button 
                    ...
                    className="flex items-center gap-2 px-8 py-3 bg-indigo-500 text-white rounded-xl text-sm font-bold hover:bg-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-indigo-500/20"
                  >
                    {isProcessing ? (
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
          ...
          <h4 className="text-white font-bold mb-4">Scalable Quality</h4>
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
          ...
          <h4 className="text-white font-bold mb-4">Instant Export</h4>
          <p className="text-gray-500 text-sm leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
          ...
          <h4 className="text-white font-bold mb-4">Privacy Guaranteed</h4>
          <p className="text-gray-500 text-sm leading-relaxed">
