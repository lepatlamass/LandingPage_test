        ...
        <div className="p-6 md:p-8 border-b border-zinc-300 dark:border-gray-800 flex flex-col md:flex-row items-start md:items-center justify-between bg-white/5 gap-6 md:gap-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-black dark:text-gray-500 text-sm">Convert CSV files to Excel spreadsheets</p>
            </div>
          </div>
          {csvState && (
            <button 
        ...
        <div className="p-8">
          {!csvState ? (
            ...
            >
              ...
              <p className="text-black dark:text-gray-500 text-sm mb-8">Select a CSV file (.csv) to convert</p>
