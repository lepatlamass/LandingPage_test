    ...
    <div className="w-full max-w-5xl mx-auto">
      <div className="bg-[#1a1c21] border border-gray-800 rounded-[32px] overflow-hidden shadow-2xl">
        <div className="p-6 md:p-8 border-b border-gray-800 flex flex-col md:flex-row items-start md:items-center justify-between bg-white/5 gap-6 md:gap-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-white">PDF to CSV</h3>
              <p className="text-gray-500 text-sm">Extract tables and data from PDF to CSV format</p>
            </div>
          </div>
          {pdfFile && (
            <button 
        ...
        <div className="p-8">
          {!pdfFile ? (
            ...
            >
              ...
              <p className="text-gray-500 text-sm mb-8">Select a PDF file to extract data</p>
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
          ...
          <h4 className="text-white font-bold mb-4">Table Extraction</h4>
