    ...
    <div className="min-h-screen bg-white dark:bg-[#111111] text-black dark:text-white font-sans selection:bg-[#d4ff33] selection:text-black">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-sm prose-invert max-w-none text-[14px] font-normal prose-p:text-black dark:text-gray-400 prose-headings:text-[16px] prose-headings:font-medium prose-headings:text-black dark:text-white prose-a:text-[#d4ff33] prose-strong:text-black dark:text-white prose-p:leading-10 prose-p:mb-20 prose-headings:mt-32 prose-headings:mb-16 prose-li:mb-8 prose-ul:mb-12 prose-p:indent-8">
          ...
          <p>We use payment data and information on your subscription, credit package, and payment history (subscription plan, credit amount, billing period, etc.) to process the regular payments for your Refinedocs subscription or credit purchases and, thus, fulfill our contract (e.g., Art. 6 (1) b GDPR). We accomplish this through our third-party payment processor, <a href="https://stripe.com/privacy">Stripe</a>. We also use Stripe as a subscription management provider. For further information on this provider, please visit section 4 below.</p>
          <p><strong>Note:</strong> Stripe handles full payment details securely; Refinedocs only receives confirmation and transaction IDs.</p>

          <h6 id="faq-1-3-b">b) Invoices</h6>
          <p>We process your account, subscription, credit package, and payment information to fulfill our legal obligations (legal data storage obligations, e.g. under tax law) (e.g., Art. 6 (1) c GDPR) and provide you with invoices under our contract (e.g., Art. 6 (1) b GDPR). We also use Stripe as a subscription management provider to help us in providing the aforementioned services.</p>
          ...
          <p>We use <strong>Stripe</strong> to process payments. Stripe acts as a data controller for payment data; please refer to the <a href="https://stripe.com/privacy">Stripe Privacy Policy</a> for details.</p>
          <ul>
