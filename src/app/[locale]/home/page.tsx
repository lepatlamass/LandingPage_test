      ...
      <header className="h-16 border-b border-white/5 flex items-center justify-between px-6 bg-[#111111] sticky top-0 z-50">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link href="/home" className="text-xs font-medium text-white transition-colors">
              {tCommon('home')}
            </Link>
            <Link href="/" className="text-xs font-medium text-gray-300 hover:text-white transition-colors">
              {tCommon('tools')}
            </Link>
        ...
        <div className="flex items-center gap-4">
          <LanguageSwitcher />
          <Link href="/" className="text-xs font-medium text-gray-300 hover:text-white transition-colors hidden sm:block">
            {tCommon('logIn')}
          </Link>
          <Link 
            href="/"
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className="p-6 rounded-xl bg-[#1a1c21] border border-white/5 hover:border-white/10 transition-colors flex flex-col h-full">
                    ...
                    <Link href={`/?tool=${tool.id}`} className="text-xs font-bold text-white flex items-center justify-end gap-1 hover:text-[#d4ff33] transition-colors mt-auto">
            ...
            <div className="space-y-20">
              ...
              <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24">
                <div className="flex-1 space-y-6">
                  ...
                  <Link href="/?tool=pdf-to-excel" className="inline-flex items-center gap-2 font-bold text-white hover:text-[#d4ff33] transition-colors">
              ...
              <div className="flex flex-col md:flex-row-reverse items-center gap-12 md:gap-24">
                <div className="flex-1 space-y-6">
                  ...
                  <Link href="/?tool=excel-to-csv" className="inline-flex items-center gap-2 font-bold text-white hover:text-[#d4ff33] transition-colors">
              ...
              <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24">
                <div className="flex-1 space-y-6">
                  ...
                  <Link href="/?tool=image-to-text" className="inline-flex items-center gap-2 font-bold text-white hover:text-[#d4ff33] transition-colors">
              ...
              <div className="flex flex-col md:flex-row-reverse items-center gap-12 md:gap-24">
                <div className="flex-1 space-y-6">
                  ...
                  <Link href="/?tool=compress-images" className="inline-flex items-center gap-2 font-bold text-white hover:text-[#d4ff33] transition-colors">
